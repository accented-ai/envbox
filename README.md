...
| `CODER_DEBUG`                        | If `true`, enables Envbox's own diagnostic logs. The outer Docker daemon remains at info level because its debug request logs can contain inner-container environment values and other credentials.                                                                                                                                                                                                                                                                                                                            | false    |
