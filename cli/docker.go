...
// those mounts through envbox's mount namespace. wrap_dockerd.sh only remounts
// a nested cgroup view and lazily unmounts it so parent processes holding that
// mount busy do not block the cgroup2 remount.
//
